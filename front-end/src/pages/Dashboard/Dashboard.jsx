        ...
        const loadData = async () => {
            try {
                ...
                setChartData([
                    ...
                    { week: 'W9', footprint: 7, saved: 9 },
                    { week: 'W10', footprint: 6, saved: 10 },
                    { week: 'W11', footprint: 5, saved: 11 },
                    { week: 'W12', footprint: 4, saved: 12 }
                ]);
                setBadges([
    ...
    return (
        <>
            ...
            <div style={styles.summaryGrid}>
                {[
                    { id: 'emitted', label: 'CO₂ Emitted', val: currentWeek.co2Emitted, unit: 'kg', icon: <TrendingDown size={32} />, color: '#c2410c', bg: '#ffedd5' },
                    { id: 'saved', label: 'CO₂ Saved', val: currentWeek.co2Saved, unit: 'kg', icon: <Leaf size={32} />, color: '#15803d', bg: '#dcfce7' },
                    { id: 'streak', label: 'Streak', val: currentWeek.streak, unit: 'days', icon: <Flame size={32} />, color: '#b91c1c', bg: '#fee2e2' },
                    { id: 'badges', label: 'Badges', val: unlockedCount, unit: `/${badges.length}`, icon: <Award size={32} />, color: '#7e22ce', bg: '#f3e8ff' }
                ].map(card => (
                    <div
                        key={card.id}
                        style={{
